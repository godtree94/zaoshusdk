...
public class InstanceApi extends AbstractApi{
    ...
    private String taskDataUrl = Constant.API_URL + "/instance/:instance_id/task/:task_id/result/file";
     ...
     * @return
     */
    public ApiResult run(String id,RunParamConfig runParamConfig,String notifyUri) throws ApiException {
        ApiResult result = new ApiResult();
        
        String requestResult = HttpUtil.post(keyPair,instanceUrl.replaceAll(":instance_id",id),null,gson.toJson(runParamConfig));
    ...
    public String getTaskData(String instanceId,String taskId,String contentType) throws ApiException {
        String requestUrl=taskDataUrl.replaceAll(":instance_id",instanceId).replaceAll(":task_id", taskId);
        Map<String,String> map=new HashMap();
        String result;
        map.put("contentType", contentType);
        result= HttpUtil.get(keyPair, requestUrl ,map);
        return result;
    }
